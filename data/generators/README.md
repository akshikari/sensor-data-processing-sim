...
- This data is generated using some base assumptions:
  - It is a quadruped robot walking following a sinusoidal walking pattern, thus a Simple Harmonic Motion can be used to model its movement
  - The robot is walking in a straight line on a flat, horizontal surface
  - To simulate noisy data, add a `noise_std_dev` parameter to modify the Gaussian distribution of the acceleration data
