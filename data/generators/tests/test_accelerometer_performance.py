...
class TestNonRealTimePerformance:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                1000, 1000, 1_000_000, id="1M_samples", marks=pytest.mark.slow
            ),
        ],
    )
    def test_non_realtime_throughput(
        self, frequency: int, duration: int, expected_samples: int
    ):
...
class TestRealTimeTiming:
    ...
    def test_realtime_vs_non_realtime_speed(self):
        ...
        gen_rt = AccelerometerGenerator(id=id)
        ...
        gen_nrt = AccelerometerGenerator(id=id)
...
class TestStreamContinuity:
    ...
    def test_continuous_sequence_numbers(self):
        ...
        assert np.array_equal(np.asarray(df["sequence"].values), expected_sequence)
...
class TestDataQualityWithAnomalies:
    ...
    def test_anomaly_impact_on_performance(self):
        ...
        # Normal generation
        gen_normal = AccelerometerGenerator(id=id)
...
class TestAsyncPerformance:
    ...
    async def test_async_batch_overhead(self):
        ...
        # Sync batch stream
        gen_sync = AccelerometerGenerator(id=id)
        ...
        # Async batch stream
        gen_async = AccelerometerGenerator(id=id)
